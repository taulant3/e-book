...
CREATE TABLE `koment` (
  ...
  PRIMARY KEY (`id`),
  KEY `episodes_koment_fk_idx` (`episodeId`),
  KEY `user_koment_fk` (`userId`),
  CONSTRAINT `episodes_koment_fk` FOREIGN KEY (`episodeId`) REFERENCES `episodes` (`id`),
  CONSTRAINT `user_koment_fk` FOREIGN KEY (`userId`) REFERENCES `user` (`id`)
